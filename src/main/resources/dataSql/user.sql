...
CREATE TABLE `pn_km-data` (
  ...
  `productionUnit` varchar(50) DEFAULT NULL COMMENT '生产单位',
  `documentNumber` varchar(50) DEFAULT NULL COMMENT '文号',
  `type` varchar(50) DEFAULT NULL COMMENT '类型',
  `isPrescription` varchar(50) DEFAULT NULL COMMENT '是否处方',
  `isMedical` varchar(50) DEFAULT NULL COMMENT '是否医保',
  `isSpecial` bigint(20) DEFAULT NULL COMMENT '是否含麻黄碱',
  `agentType` bigint(20) DEFAULT NULL COMMENT '剂型',
